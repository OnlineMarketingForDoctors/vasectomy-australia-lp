/** New South Wales. Generated from the live landing pages; edit here, not there. */
import { loc, TIMELY, type Location } from "../location";

export const sydney: Location = loc({
  slug: "/sydney",
  city: "Sydney",
  state: "NSW",
...
export const newcastle: Location = loc({
  slug: "/newcastle",
  city: "Newcastle",
  state: "NSW",
...
export const brookvale: Location = loc({
  slug: "/brookvale",
  city: "the Northern Beaches",
  cityIn: "on Sydney's Northern Beaches",
  state: "NSW",
  eyebrow: "Brookvale · Northern Beaches",
  metaTitle: "Vasectomy Northern Beaches | No-Scalpel Vasectomy — Vasectomy Australia",
  metaDescription: "No-scalpel, open-ended vasectomy on Sydney's Northern Beaches. About 15 minutes under local anaesthetic, $597 out of pocket after your Medicare rebate. Brookvale, on Dale Street.",
  indexSummary: "No-scalpel vasectomy on Sydney's Northern Beaches, at Brookvale.",
  heroIntro: "On the Northern Beaches, in about 15 minutes, under local anaesthetic.",
  heroWhere: "after your Medicare rebate — at the Warringah Medical & Dental Centre on Dale Street, Brookvale.",
...
export const centralCoast: Location = loc({
  slug: "/central-coast",
  city: "the Central Coast",
  cityIn: "on the Central Coast",
  state: "NSW",
  eyebrow: "Gosford · Central Coast",
  metaTitle: "Vasectomy Central Coast | No-Scalpel Vasectomy — Vasectomy Australia",
  metaDescription: "No-scalpel, open-ended vasectomy on the Central Coast. About 15 minutes under local anaesthetic, $597 out of pocket after your Medicare rebate. Gosford, on Hills Street.",
  indexSummary: "No-scalpel vasectomy on the Central Coast, at Gosford.",
  heroIntro: "On the Central Coast, in about 15 minutes, under local anaesthetic.",
  heroWhere: "after your Medicare rebate — at Gynaecology Centres Australia on Hills Street, Gosford.",
  operatingDoctor: "geoff",
  locations: {
...
export const wollongong: Location = loc({
  slug: "/wollongong",
  city: "Wollongong",
  state: "NSW",
  eyebrow: "Dapto · Wollongong",
  metaTitle: "Vasectomy Wollongong | No-Scalpel Vasectomy — Vasectomy Australia",
  metaDescription: "No-scalpel, open-ended vasectomy in Wollongong. About 15 minutes under local anaesthetic, $597 out of pocket after your Medicare rebate. Dapto, on the Princes Highway.",
  indexSummary: "No-scalpel vasectomy in Wollongong and the Illawarra, at Dapto.",
  heroIntro: "In Wollongong, in about 15 minutes, under local anaesthetic.",
  heroWhere: "after your Medicare rebate — at the Dapto Medical Centre, on the Princes Highway.",
  operatingDoctor: "geoff",
  locations: {
...
export const dubbo: Location = loc({
  slug: "/dubbo",
  city: "Dubbo",
  state: "NSW",
  eyebrow: "Dubbo · NSW",
  metaTitle: "Vasectomy Dubbo | No-Scalpel Vasectomy — Vasectomy Australia",
  metaDescription: "No-scalpel, open-ended vasectomy in Dubbo. About 15 minutes under local anaesthetic, $597 out of pocket after your Medicare rebate. Dubbo, on Windsor Parade.",
  indexSummary: "No-scalpel vasectomy in Dubbo, at the Western Plains Medical Centre.",
  heroIntro: "In Dubbo, in about 15 minutes, under local anaesthetic.",
  heroWhere: "after your Medicare rebate — at the Western Plains Medical Centre on Windsor Parade.",
  operatingDoctor: "geoff",
  locations: {
...
export const portMacquarie: Location = loc({
  slug: "/port-macquarie",
  city: "Port Macquarie",
  state: "NSW",
  eyebrow: "Port Macquarie · NSW",
  metaTitle: "Vasectomy Port Macquarie | No-Scalpel Vasectomy — Vasectomy Australia",
  metaDescription: "No-scalpel, open-ended vasectomy in Port Macquarie. About 15 minutes under local anaesthetic, $597 out of pocket after your Medicare rebate. Port Macquarie, on Hastings River Drive.",
  indexSummary: "No-scalpel vasectomy in Port Macquarie and the Mid North Coast.",
  heroIntro: "In Port Macquarie, in about 15 minutes, under local anaesthetic.",
  heroWhere: "after your Medicare rebate — at the Port Macquarie Medical & Dental Centre, on Hastings River Drive.",
  operatingDoctor: "geoff",
  locations: {
...
export const tamworth: Location = loc({
  slug: "/tamworth",
  city: "Tamworth",
  state: "NSW",
  eyebrow: "Tamworth · NSW",
  metaTitle: "Vasectomy Tamworth | No-Scalpel Vasectomy — Vasectomy Australia",
  metaDescription: "No-scalpel, open-ended vasectomy in Tamworth. About 15 minutes under local anaesthetic, $597 out of pocket after your Medicare rebate. Tamworth, on Marius Street.",
  indexSummary: "No-scalpel vasectomy in Tamworth and the New England North West.",
  heroIntro: "In Tamworth, in about 15 minutes, under local anaesthetic.",
  heroWhere: "after your Medicare rebate — at East Tamworth Medical Centre on Marius Street.",
  operatingDoctor: "geoff",
  locations: {
...
export const orange: Location = loc({
  slug: "/orange",
  city: "Orange",
  state: "NSW",
  eyebrow: "Orange · NSW",
  metaTitle: "Vasectomy Orange | No-Scalpel Vasectomy — Vasectomy Australia",
  metaDescription: "No-scalpel, open-ended vasectomy in Orange. About 15 minutes under local anaesthetic, $597 out of pocket after your Medicare rebate. Orange, on Peisley Street.",
  indexSummary: "No-scalpel vasectomy in Orange and the Central Tablelands.",
  heroIntro: "In Orange, in about 15 minutes, under local anaesthetic.",
  heroWhere: "after your Medicare rebate — at the Orange Family Medical Centre on Peisley Street.",
  operatingDoctor: "geoff",
  locations: {
...
export const waggaWagga: Location = loc({
  slug: "/wagga-wagga",
  city: "Wagga Wagga",
  state: "NSW",
  eyebrow: "Wagga Wagga · NSW",
  metaTitle: "Vasectomy Wagga Wagga | No-Scalpel Vasectomy — Vasectomy Australia",
  metaDescription: "No-scalpel, open-ended vasectomy in Wagga Wagga. About 15 minutes under local anaesthetic, $597 out of pocket after your Medicare rebate. Wagga Wagga, on Baylis Street.",
  indexSummary: "No-scalpel vasectomy in Wagga Wagga and the Riverina.",
  heroIntro: "In Wagga Wagga, in about 15 minutes, under local anaesthetic.",
  heroWhere: "after your Medicare rebate — at the Wagga Wagga Medical Centre on Baylis Street.",
  operatingDoctor: "geoff",
  locations: {
...
export const alburyWodonga: Location = loc({
  slug: "/albury-wodonga",
  city: "Albury–Wodonga",
  state: "NSW",
  eyebrow: "Albury · Albury–Wodonga",
  metaTitle: "Vasectomy Albury–Wodonga | No-Scalpel Vasectomy — Vasectomy Australia",
  metaDescription: "No-scalpel, open-ended vasectomy in Albury–Wodonga. About 15 minutes under local anaesthetic, $597 out of pocket after your Medicare rebate. Albury, on Olive Street.",
  indexSummary: "No-scalpel vasectomy in Albury–Wodonga, on Olive Street.",
  heroIntro: "In Albury–Wodonga, in about 15 minutes, under local anaesthetic.",
  heroWhere: "after your Medicare rebate — at innovate Health Albury on Olive Street.",
  operatingDoctor: "geoff",
  locations: {
...
export const ballina: Location = loc({
  slug: "/ballina",
  city: "Ballina",
  state: "NSW",
  eyebrow: "Ballina · NSW",
  metaTitle: "Vasectomy Ballina | No-Scalpel Vasectomy — Vasectomy Australia",
  metaDescription: "No-scalpel, open-ended vasectomy in Ballina. About 15 minutes under local anaesthetic, $597 out of pocket after your Medicare rebate. Ballina, on Tamar Street.",
  indexSummary: "No-scalpel vasectomy in Ballina and the Northern Rivers.",
  heroIntro: "In Ballina, in about 15 minutes, under local anaesthetic.",
  heroWhere: "after your Medicare rebate — at the Ballina Health Centre on Tamar Street.",
